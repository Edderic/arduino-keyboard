...
#define PIN_RIGHT_CONTROL 6 // will be moved to right Sketch
#define PIN_RIGHT_SHIFT   7 // will be moved to right Sketch
#define PIN_RIGHT_ALT     8 // will be moved to right Sketch
#define PIN_RIGHT_GUI     9 // will be moved to right Sketch
...
#define PIN_KEY_3 27
#define PIN_KEY_DOT 28
#define PIN_KEY_E 29
#define PIN_KEY_J 30
#define PIN_KEY_LEFT 31
...
// set up by columns (Kinesis Advantage Dvorak custom)
int regularValues[] = {
  KEY_5,
  KEY_Y,
  KEY_I,
...
void loop()
{
  ...
  for(int i = 0; i < numRegularInputs; i++) {
    ...
    // TODO: we should collect all the pressed keys and then send the value
