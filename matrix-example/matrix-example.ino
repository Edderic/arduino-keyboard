...
// key function will be handled as edge case
...
// int keyValues[10][8] = {
  ...
  // { KEY_2, KEY_COMMA,      KEY_O, KEY_Q,          KEY_GRAVE,      0,             0,             0,                   },
  // { KEY_3, KEY_DOT,        KEY_E, KEY_J,          KEY_BACKSLASH,  KEY_LEFTMETA,  KEY_LEFTSHIFT, KEY_FUNCTION,        },
  // { KEY_4, KEY_P,          KEY_U, KEY_K,          KEY_LEFT,       KEY_LEFTALT,   KEY_BACKSPACE, KEY_DELETE,          },
  // { KEY_5, KEY_Y,          KEY_I, KEY_X,          KEY_RIGHT,      KEY_ESC,       KEY_LEFTCTRL,  KEY_TAB,             },
  // { KEY_6, KEY_F,          KEY_D, KEY_B,          KEY_UP,         KEY_EQUAL,     KEY_MINUS,     KEY_SLASH,           },
  // { KEY_7, KEY_G,          KEY_H, KEY_M,          KEY_DOWN,       KEY_RIGHTALT,  KEY_SPACE,     KEY_ENTER,           },
  // { KEY_8, KEY_C,          KEY_T, KEY_W,          KEY_LEFTBRACE,  KEY_RIGHTMETA, KEY_ENTER,     KEY_RIGHTCTRL,       },
  // { KEY_9, KEY_R,          KEY_N, KEY_V,          KEY_RIGHTBRACE, 0,             0,             0,                   },
  // { KEY_0, KEY_L,          KEY_S, KEY_Z,          0,              0,             0,             0,                   }
// };
int keyValues[10][8] = {
  { KEY_1, KEY_APOSTROPHE, KEY_A, KEY_SEMICOLON,  0,              0,             0,             0,                   },
  { KEY_2, KEY_COMMA,      KEY_O, KEY_Q,          KEY_GRAVE,      0,             0,             0,                   },
  { KEY_3, KEY_DOT,        KEY_E, KEY_J,          KEY_BACKSLASH,  KEY_A,  KEY_G, KEY_M,        },
  { KEY_4, KEY_P,          KEY_U, KEY_K,          KEY_LEFT,       KEY_B,  KEY_H, KEY_N,          },
  { KEY_5, KEY_Y,          KEY_I, KEY_X,          KEY_RIGHT,      KEY_C,  KEY_I, KEY_O,             },
  { KEY_6, KEY_F,          KEY_D, KEY_B,          KEY_UP,         KEY_D,  KEY_J, KEY_P,           },
  { KEY_7, KEY_G,          KEY_H, KEY_M,          KEY_DOWN,       KEY_E,  KEY_K, KEY_Q,           },
  { KEY_8, KEY_C,          KEY_T, KEY_W,          KEY_LEFTBRACE,  KEY_F,  KEY_L, KEY_R,       },
  { KEY_9, KEY_R,          KEY_N, KEY_V,          KEY_RIGHTBRACE, 0,             0,             0,                   },
  { KEY_0, KEY_L,          KEY_S, KEY_Z,          0,              0,             0,             0,                   }
};
